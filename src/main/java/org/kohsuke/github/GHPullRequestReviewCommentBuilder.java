...
public class GHPullRequestReviewCommentBuilder {
   ...
   * <p>
   * {@link #side(GHPullRequestReviewComment.Side)} and {@link #sides(GHPullRequestReviewComment.Side, GHPullRequestReviewComment.Side)} will overwrite each other's values.
   *
   * @param side side of the diff to which the comment applies
   * @return the gh pull request review comment builder
   */
   ...
   * {@link #side(GHPullRequestReviewComment.Side)} and {@link #sides(GHPullRequestReviewComment.Side, GHPullRequestReviewComment.Side)} will overwrite each other's values.
   *
   * @param startSide side of the diff to which the start of the comment applies
   * @param endSide   side of the diff to which the end of the comment applies
   * @return the gh pull request review comment builder
   */
