...
public class RepositoryTest {
    ...
    public void listCollaborators() throws Exception {
        ...
        when(mockRepository.getAllCollaborators()).thenReturn(pagedIterable);
        ...
        Iterator<GHUser> returnIterator1 = mockRepository.getAllCollaborators().iterator();
        ...
        Iterator returnIterator2 = mockRepository.getAllCollaborators().iterator();
